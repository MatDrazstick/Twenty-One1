...
const settings2: GameSettings = { timerSeconds: 15 };
...
const settings3: GameSettings = { timerSeconds: 45 };
...
const settings4: GameSettings = { timerSeconds: 90 };
...
const settings5: GameSettings = { moveDistanceMode: 'shuffle' };
...
const settings6: GameSettings = { firstPlayer: 'player2' };
...
const settings7: GameSettings = { firstPlayer: 'random' };
...
const settings10: GameSettings = { moveDistanceMode: 'shuffle' };
...
const settings11: GameSettings = { moveDistanceMode: 'rise' };
